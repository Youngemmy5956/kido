...
var tabc = document.querySelectorAll(".tab-c");
var deposite = document.querySelector(".deposite");
var depoContent = document.querySelector(".depoContent");
var terminate = document.querySelector(".terminate");
var wterminate = document.querySelector(".wterminate");
...
var withdrawContent = document.querySelector(".withdrawContent");
...
wallet.addEventListener("click", function () {
  ...
  formdata.append("file", file.files[0], "prove.".concat(file.files[0].type.replace("image/", "")));
  fetch("http://localhost:8000/api/user/approval", {
    ...
    if (/Payment/gi.test(val.data)) {
      var n = error.getAttribute("class").replace("text-red-600", "text-green-600");

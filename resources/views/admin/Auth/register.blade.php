                ...
                <form action="{{ route('admin.register') }}" method="post" class="space-y-6">
                    ...
                    <div class="flex" class="w-full">
                     ...
                     @error('name')
                        <p class="text-red-500">{{ $message }}</p>
                    @enderror
                    <input type="text" name="name" value="{{ old('name') }}" class="block border w-full h-12 p-3 focus:border-blue-500 focus:border-2" placeholder="Name">
                    @error('email')
                        <p class="text-red-500">{{ $message }}</p>
                    @enderror
                 ...
                 <div class="text-center"><a href="{{ route('admin.login') }}" class="text-blue-500">Already have an account?</a></div>
                </div>

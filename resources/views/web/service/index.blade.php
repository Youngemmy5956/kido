                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-7 col-md-12 col-sm-12 col-12">
                            <div class="dg__secure__inner">
                                ...
                                <p>Our investment platform is a product of careful preparation and fruitful work of experts
                                    in the field of Bitcoin mining, highly profitable trade in cryptocurrencies and online
                                    marketing. Using modern methods of doing business and a personal approach to each
                                    client, we offer a unique investment model to people who want to use Bitcoin not only as
                                    a method of payment, but also as a reliable source of stable income. KOINBETTER uses
                                    only modern mining equipment and trades at the most stable markets, which minimizes the
                                    risk of financial loss to customers and guarantees them a stable income accrued every
                                    calendar day.</p>
                                <p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="section__title--6">
                                ...
                                <p>KOINBETTER a cryptocurrency partners which has been I identified with the test of time,
                                    thoroughly over the past 5 years and they are the most dynamically developing
                                    institutional firm in the cryptocurrency assets, the firm taking it stand as a mandate
                                    before 2025,to become the next global giant in the circulation market.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="custom__service__width">
                        ...
                        <div class="service__2">
                            ...
                            <div class="content">
                                ...
                                <p>CBC’s Team Members step into the shoes of the Independent Banker and, based upon their
                                    experience and current knowledge of the marketplace.</p>
                            </div>
                        </div>
                        <!-- End Single Service -->
                        <!-- Start Single Service -->
                    ...
                    <div class="custom__service__width">
                        ...
                        <div class="service__2">
                            ...
                            <div class="content">
                                ...
                                <p>Community Bank Connection provides intelligent, compliant, and focused solutions
